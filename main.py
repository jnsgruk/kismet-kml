...
class KMLGen():
    ...
    def createKML(self):
        try:
            ...
            document.Document.append(KML.Style(KML.IconStyle(KML.scale(1.0), KML.color('50B41E14'), KML.Icon(KML.href(
                "http://maps.google.com/mapfiles/kml/shapes/placemark_circle.png"),), id="blue_circle"), id="blue_circle"))
            document.Document.append(KML.Style(KML.IconStyle(KML.scale(1.0), KML.color('ff00C2ff'), KML.Icon(KML.href(
                "http://maps.google.com/mapfiles/kml/shapes/placemark_circle.png"),), id="amber_circle"), id="amber_circle"))
            document.Document.append(KML.Style(KML.IconStyle(KML.scale(1.0), KML.color('ff00ff00'), KML.Icon(KML.href(
                "http://maps.google.com/mapfiles/kml/shapes/placemark_circle.png"),), id="green_circle"), id="green_circle"))
            document.Document.append(KML.Style(KML.IconStyle(KML.scale(1.0), KML.color('501400FF'), KML.Icon(KML.href(
                "http://maps.google.com/mapfiles/kml/shapes/placemark_circle.png"),), id="red_circle"), id="red_circle"))
            ...
            for client in self.clients:
                if client["Locations"]:
                    ...
                    for probe in client["Probes"]:
                        extData.append(
                            KML.Data(KML.value(probe["SSID"]), name="Probed SSID"))
                    ...
                    for i, ap in enumerate(client["APs"]):
                        ...
                        if len(clist) > 0:
                            ssid = clist[0]["SSID"]
                            extData.append(
                                KML.Data(KML.value(ssid), name="AP " + str(i) + " SSID"))
                        extData.append(
                            KML.Data(KML.value(ap["BSSID"]), name="AP " + str(i) + " BSSID"))
            ...
            for ap in self.aps:
                if ap["Locations"]:
                    ...
                    for client in ap["Clients"]:
                        extData.append(
                            KML.Data(KML.value(client["Device MAC"]), name="Client Device MAC"))
